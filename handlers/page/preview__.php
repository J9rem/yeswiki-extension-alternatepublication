...
use YesWiki\Alternatepublication\Service\Publication;
...
if ($publication) {
    ...
    $cssFiles = array_merge(
        glob('tools/alternatepublication/presentation/styles/print-layouts/'.$metadatas['publication-mode'].'.css'),
        glob('tools/alternatepublication/presentation/styles/*.css'),
        glob('themes/'.$wiki->config['favorite_theme'].'/tools/alternatepublication/*.css'),
        glob('themes/'.$wiki->config['favorite_theme'].'/tools/alternatepublication/print-layouts/'.$metadatas['publication-mode'].'.css'),
        glob('custom/tools/alternatepublication/*.css'),
        glob('custom/tools/alternatepublication/print-layouts/'.$metadatas['publication-mode'].'.css'),
    );
    ...
    $output = $templateEngine->render('@alternatepublication/print-layouts/'.$metadatas['publication-mode'].'.twig', [
