# yeswiki-extension-alternativepublication

Extension [YesWiki](https://yeswiki.net/) pour régler les soucis de bazar2publication
...
## Auteurs
 ...
 - Florian Schmitt
 - Thomas Parisot
 - et tous les contributeurs et toutes les contributrices indiqués sur cette page : <https://github.com/J9rem/yeswiki-extension-alternativepublication/graphs/contributors>

## Installation

Dans la page `GererMisesAJour` de votre YesWiki, recherchez l'extension `alternativepublication` et installez-là.
...
| ---                                                         | ---                       | ---
| `custom/tools/alternatepublication/*.css`                            | Peu importe               | Toute publication, peu importe le thème
| `custom/tools/alternatepublication/print-layouts/*.css`              | `fanzine.css`, `book.css` | Seulement les fanzines, ou les livres/livrets, peu importe le thème
| `themes/NOM_DU_THEME/tools/alternatepublication/*.css`               | Peu importe               | Toute publication, pour un thème donné
| `themes/NOM_DU_THEME/tools/alternatepublication/print-layouts/*.css` | `fanzine.css`, `book.css` | Seulement les fanzines, ou les livres/livrets, pour un thème donné
